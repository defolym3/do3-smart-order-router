...
import { ITokenProvider, TokenAccessor, TUNA_BASE, USDC_BASE, USDC_SHAPE_TESTNET, USDC_MODE, USDC_OPTIMISM } from './token-provider';
...
export const CACHE_SEED_TOKENS: {
  ...
  [ChainId.SHAPE_TESTNET]: {
    USDC: USDC_SHAPE_TESTNET,
    WETH: WRAPPED_NATIVE_CURRENCY[ChainId.SHAPE_TESTNET],
  },
  [ChainId.MODE]: {
    USDC: USDC_MODE,
